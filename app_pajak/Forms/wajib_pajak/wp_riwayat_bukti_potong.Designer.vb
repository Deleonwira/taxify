...
Partial Class wp_riwayat_bukti_potong
    ...
    Private Sub InitializeComponent()
        ...
        Company1Name = New Guna.UI2.WinForms.Guna2HtmlLabel()
        Company1Stat = New Guna.UI2.WinForms.Guna2HtmlLabel()
        CardCompany2 = New Guna.UI2.WinForms.Guna2Panel()
        PicCompany2 = New Guna.UI2.WinForms.Guna2CirclePictureBox()
        Company2Name = New Guna.UI2.WinForms.Guna2HtmlLabel()
        Company2Stat = New Guna.UI2.WinForms.Guna2HtmlLabel()
        CardCompany3 = New Guna.UI2.WinForms.Guna2Panel()
        ...
        GridBukti.ThemeStyle.AlternatingRowsStyle.ForeColor = Color.Empty
        ...
        GridBukti.ThemeStyle.ReadOnly = True
        GridBukti.ThemeStyle.RowsStyle.BackColor = Color.White
        GridBukti.ThemeStyle.RowsStyle.BorderStyle = DataGridViewCellBorderStyle.SingleHorizontal
        GridBukti.ThemeStyle.RowsStyle.Font = New Font("Segoe UI", 9.0F)
        GridBukti.ThemeStyle.RowsStyle.ForeColor = Color.FromArgb(CByte(71), CByte(69), CByte(94))
        GridBukti.ThemeStyle.RowsStyle.Height = 36
        GridBukti.ThemeStyle.RowsStyle.SelectionBackColor = Color.FromArgb(CByte(231), CByte(229), CByte(255))
        GridBukti.ThemeStyle.RowsStyle.SelectionForeColor = Color.FromArgb(CByte(71), CByte(69), CByte(94))
        ' 
        ' colPeriode
        ' 
        colPeriode.HeaderText = "Periode"
        colPeriode.MinimumWidth = 60
        ...
        ' CardCompany1
        ' 
        CardCompany1.BorderColor = Color.FromArgb(CByte(230), CByte(233), CByte(241))
        CardCompany1.BorderRadius = 12
        CardCompany1.BorderThickness = 1
        ...
        ' PicCompany1
        ' 
        PicCompany1.FillColor = Color.FromArgb(CByte(0), CByte(122), CByte(255))
        ...
        PicCompany1.TabStop = False
        ' 
        ' Company1Name
        ' 
        Company1Name.BackColor = Color.Transparent
        Company1Name.Font = New Font("Segoe UI Semibold", 10.0F, FontStyle.Bold)
        Company1Name.ForeColor = Color.FromArgb(CByte(35), CByte(44), CByte(63))
        Company1Name.Location = New Point(78, 18)
        Company1Name.Name = "Company1Name"
        Company1Name.Size = New Size(107, 19)
        Company1Name.TabIndex = 1
        Company1Name.Text = "PT Aurora Kreatif"
        ' 
        ' Company1Stat
        ' 
        Company1Stat.BackColor = Color.Transparent
        Company1Stat.Font = New Font("Segoe UI", 9.0F)
        Company1Stat.ForeColor = Color.FromArgb(CByte(120), CByte(128), CByte(146))
        Company1Stat.Location = New Point(78, 48)
        Company1Stat.Name = "Company1Stat"
        Company1Stat.Size = New Size(121, 17)
        Company1Stat.TabIndex = 2
        Company1Stat.Text = "4 bukti • Rp 82.000.000"
        ' 
        ' CardCompany2
        ' 
        CardCompany2.BorderColor = Color.FromArgb(CByte(230), CByte(233), CByte(241))
        CardCompany2.BorderRadius = 12
        CardCompany2.BorderThickness = 1
        ...
        ' PicCompany2
        ' 
        PicCompany2.FillColor = Color.FromArgb(CByte(52), CByte(199), CByte(89))
        ...
        PicCompany2.TabStop = False
        ' 
        ' Company2Name
        ' 
        Company2Name.BackColor = Color.Transparent
        Company2Name.Font = New Font("Segoe UI Semibold", 10.0F, FontStyle.Bold)
        Company2Name.ForeColor = Color.FromArgb(CByte(35), CByte(44), CByte(63))
        Company2Name.Location = New Point(78, 18)
        Company2Name.Name = "Company2Name"
        Company2Name.Size = New Size(118, 19)
        Company2Name.TabIndex = 1
        Company2Name.Text = "PT Samudra Digital"
        ' 
        ' Company2Stat
        ' 
        Company2Stat.BackColor = Color.Transparent
        Company2Stat.Font = New Font("Segoe UI", 9.0F)
        Company2Stat.ForeColor = Color.FromArgb(CByte(120), CByte(128), CByte(146))
        Company2Stat.Location = New Point(78, 48)
        Company2Stat.Name = "Company2Stat"
        Company2Stat.Size = New Size(121, 17)
        Company2Stat.TabIndex = 2
        Company2Stat.Text = "3 bukti • Rp 65.000.000"
        ' 
        ' CardCompany3
        ' 
        CardCompany3.BorderColor = Color.FromArgb(CByte(230), CByte(233), CByte(241))
        CardCompany3.BorderRadius = 12
        CardCompany3.BorderThickness = 1
        ...
        ' PicCompany3
        ' 
        PicCompany3.FillColor = Color.FromArgb(CByte(255), CByte(159), CByte(10))
        ...
        PicCompany3.TabStop = False
        ' 
        ' Company3Name
        ' 
        Company3Name.BackColor = Color.Transparent
        Company3Name.Font = New Font("Segoe UI Semibold", 10.0F, FontStyle.Bold)
        Company3Name.ForeColor = Color.FromArgb(CByte(35), CByte(44), CByte(63))
        Company3Name.Location = New Point(78, 18)
        Company3Name.Name = "Company3Name"
        Company3Name.Size = New Size(132, 19)
        Company3Name.TabIndex = 1
        Company3Name.Text = "Studio Nebula Works"
        ' 
        ' Company3Stat
        ' 
        Company3Stat.BackColor = Color.Transparent
        Company3Stat.Font = New Font("Segoe UI", 9.0F)
        Company3Stat.ForeColor = Color.FromArgb(CByte(120), CByte(128), CByte(146))
        Company3Stat.Location = New Point(78, 48)
        Company3Stat.Name = "Company3Stat"
        Company3Stat.Size = New Size(121, 17)
        ...
        LblTitle.Size = New Size(244, 27)
        LblTitle.TabIndex = 1
        LblTitle.Text = "Riwayat Bukti Potong PPh21"
        ' 
        ' wp_riwayat_bukti_potong
        ' 
        ...
        Name = "wp_riwayat_bukti_potong"
        StartPosition = FormStartPosition.CenterScreen
        Text = "Riwayat Bukti Potong PPh21"
        ...
        CType(PicCompany1, ComponentModel.ISupportInitialize).EndInit()
        CardCompany2.ResumeLayout(False)
        CardCompany2.PerformLayout()
        CType(PicCompany2, ComponentModel.ISupportInitialize).EndInit()
    ...
    Friend WithEvents FlowCompanies As FlowLayoutPanel
    Friend WithEvents CardCompany1 As Guna.UI2.WinForms.Guna2Panel
    Friend WithEvents PicCompany1 As Guna.UI2.WinForms.Guna2CirclePictureBox
    Friend WithEvents Company1Name As Guna.UI2.WinForms.Guna2HtmlLabel
    Friend WithEvents Company1Stat As Guna.UI2.WinForms.Guna2HtmlLabel
    Friend WithEvents CardCompany2 As Guna.UI2.WinForms.Guna2Panel
    Friend WithEvents PicCompany2 As Guna.UI2.WinForms.Guna2CirclePictureBox
    Friend WithEvents Company2Name As Guna.UI2.WinForms.Guna2HtmlLabel
    Friend WithEvents Company2Stat As Guna.UI2.WinForms.Guna2HtmlLabel
    Friend WithEvents CardCompany3 As Guna.UI2.WinForms.Guna2Panel

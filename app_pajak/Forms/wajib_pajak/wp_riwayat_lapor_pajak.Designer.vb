...
Partial Class wp_riwayat_lapor_pajak
    ...
    Private Sub InitializeComponent()
        ...
        CmbTahun = New Guna.UI2.WinForms.Guna2ComboBox()
        ...
        GridRiwayat.ThemeStyle.HeaderStyle.Font = New Font("Segoe UI", 9F)
        ...
        GridRiwayat.ThemeStyle.RowsStyle.Font = New Font("Segoe UI", 9F)
        ...
        BtnDownloadSemua.Font = New Font("Segoe UI Semibold", 9F, FontStyle.Bold)
        ...
        LblTableSubtitle.Size = New Size(293, 17)
        ...
        LblTableTitle.Size = New Size(157, 22)
        ...
        CmbStatus.Location = New Point(618, 71)
        CmbStatus.Name = "CmbStatus"
        CmbStatus.ShadowDecoration.CustomizableEdges = CustomizableEdges10
        CmbStatus.Size = New Size(127, 36)
        CmbStatus.StartIndex = 0
        CmbStatus.TabIndex = 3
        ' 
        ' CmbTahun
        ' 
        CmbTahun.BackColor = Color.Transparent
        CmbTahun.BorderRadius = 8
        CmbTahun.CustomizableEdges = CustomizableEdges11
        CmbTahun.DrawMode = DrawMode.OwnerDrawFixed
        CmbTahun.DropDownStyle = ComboBoxStyle.DropDownList
        CmbTahun.FocusedColor = Color.FromArgb(CByte(94), CByte(148), CByte(255))
        CmbTahun.FocusedState.BorderColor = Color.FromArgb(CByte(94), CByte(148), CByte(255))
        CmbTahun.Font = New Font("Segoe UI", 9F)
        CmbTahun.ForeColor = Color.FromArgb(CByte(68), CByte(88), CByte(112))
        CmbTahun.ItemHeight = 30
        CmbTahun.Items.AddRange(New Object() {"Semua Tahun", "2024", "2025"})
        CmbTahun.Location = New Point(479, 71)
        CmbTahun.Name = "CmbTahun"
        CmbTahun.ShadowDecoration.CustomizableEdges = CustomizableEdges12
        CmbTahun.Size = New Size(133, 36)
        CmbTahun.StartIndex = 0
        CmbTahun.TabIndex = 2
        ' 
        ' TxtSearch
        ' 
        ...
        TxtSearch.PlaceholderText = "Cari Tahun atau ID"
        ...
        LblFilterSubtitle.Size = New Size(232, 17)
        ...
        LblFilterTitle.Font = New Font("Segoe UI Semibold", 10F, FontStyle.Bold)
        ...
        LblFilterTitle.Size = New Size(109, 19)
        ...
        BtnCreate.CustomizableEdges = CustomizableEdges17
        BtnCreate.FillColor = Color.White
        BtnCreate.Font = New Font("Segoe UI Semibold", 9F, FontStyle.Bold)
        BtnCreate.ForeColor = Color.FromArgb(CByte(156), CByte(0), CByte(219))
        BtnCreate.Location = New Point(926, 34)
        BtnCreate.Name = "BtnCreate"
        BtnCreate.ShadowDecoration.CustomizableEdges = CustomizableEdges18
        ...
        LblHeaderSubtitle.Size = New Size(292, 17)
        ...
        LblHeaderTitle.Size = New Size(196, 27)
        ...
        Guna2Button1.FillColor = Color.FromArgb(CByte(156), CByte(0), CByte(219))
        Guna2Button1.Font = New Font("Segoe UI Semibold", 9F, FontStyle.Bold)
        Guna2Button1.ForeColor = Color.White
        Guna2Button1.Location = New Point(868, 71)
        Guna2Button1.Name = "Guna2Button1"
        Guna2Button1.ShadowDecoration.CustomizableEdges = CustomizableEdges8
        Guna2Button1.Size = New Size(82, 36)
        Guna2Button1.TabIndex = 4
        Guna2Button1.Text = "Cari"
        ' 
        ' Guna2Button2
        ' 
        Guna2Button2.BorderColor = Color.FromArgb(CByte(156), CByte(0), CByte(219))
        ...
        Guna2Button2.Location = New Point(956, 71)
        Guna2Button2.Name = "Guna2Button2"
        Guna2Button2.ShadowDecoration.CustomizableEdges = CustomizableEdges6
        Guna2Button2.Size = New Size(82, 36)

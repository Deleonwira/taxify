...
Partial Class FrmManagementPerusahaan
    ...
    Private Sub InitializeComponent()
        ...
        CardTotalPerusahaan = New Guna.UI2.WinForms.Guna2Panel()
        LblTotalPerusahaanValue = New Guna.UI2.WinForms.Guna2HtmlLabel()
        LblTotalPerusahaanTitle = New Guna.UI2.WinForms.Guna2HtmlLabel()
        CardActivePerusahaan = New Guna.UI2.WinForms.Guna2Panel()
        LblActivePerusahaanValue = New Guna.UI2.WinForms.Guna2HtmlLabel()
        LblActivePerusahaanTitle = New Guna.UI2.WinForms.Guna2HtmlLabel()
        CardPendingPerusahaan = New Guna.UI2.WinForms.Guna2Panel()
        LblPendingPerusahaanValue = New Guna.UI2.WinForms.Guna2HtmlLabel()
        LblPendingPerusahaanTitle = New Guna.UI2.WinForms.Guna2HtmlLabel()
        CardInactivePerusahaan = New Guna.UI2.WinForms.Guna2Panel()
        LblInactivePerusahaanValue = New Guna.UI2.WinForms.Guna2HtmlLabel()
        LblInactivePerusahaanTitle = New Guna.UI2.WinForms.Guna2HtmlLabel()
        ...
        CardActivePerusahaan.SuspendLayout()
        CardPendingPerusahaan.SuspendLayout()
        CardInactivePerusahaan.SuspendLayout()
        ...
        ' FlowStats
        ' 
        FlowStats.Controls.Add(CardTotalPerusahaan)
        FlowStats.Controls.Add(CardActivePerusahaan)
        FlowStats.Controls.Add(CardPendingPerusahaan)
        FlowStats.Controls.Add(CardInactivePerusahaan)
        ...
        ' CardTotalPerusahaan
        ' 
        CardTotalPerusahaan.BorderColor = Color.FromArgb(CByte(230), CByte(233), CByte(241))
        CardTotalPerusahaan.BorderRadius = 10
        CardTotalPerusahaan.BorderThickness = 1
        CardTotalPerusahaan.Controls.Add(LblTotalPerusahaanValue)
        CardTotalPerusahaan.Controls.Add(LblTotalPerusahaanTitle)
        CardTotalPerusahaan.CustomizableEdges = CustomizableEdges3
        CardTotalPerusahaan.FillColor = Color.White
        CardTotalPerusahaan.Location = New Point(8, 8)
        CardTotalPerusahaan.Margin = New Padding(4)
        CardTotalPerusahaan.Name = "CardTotalPerusahaan"
        CardTotalPerusahaan.Padding = New Padding(18)
        CardTotalPerusahaan.ShadowDecoration.CustomizableEdges = CustomizableEdges4
        CardTotalPerusahaan.Size = New Size(220, 90)
        CardTotalPerusahaan.TabIndex = 0
        ' 
        ' LblTotalPerusahaanValue
        ' 
        LblTotalPerusahaanValue.BackColor = Color.Transparent
        LblTotalPerusahaanValue.Font = New Font("Segoe UI Semibold", 14.0F, FontStyle.Bold)
        ...
        ' 
        ' LblTotalPerusahaanTitle
        ' 
        LblTotalPerusahaanTitle.BackColor = Color.Transparent
        LblTotalPerusahaanTitle.Font = New Font("Segoe UI Semibold", 9.0F, FontStyle.Bold)
        ...
        ' 
        ' CardActivePerusahaan
        ' 
        CardActivePerusahaan.BorderColor = Color.FromArgb(CByte(230), CByte(233), CByte(241))
        CardActivePerusahaan.BorderRadius = 10
        CardActivePerusahaan.BorderThickness = 1
        CardActivePerusahaan.Controls.Add(LblActivePerusahaanValue)
        CardActivePerusahaan.Controls.Add(LblActivePerusahaanTitle)
        CardActivePerusahaan.CustomizableEdges = CustomizableEdges5
        CardActivePerusahaan.FillColor = Color.White
        CardActivePerusahaan.Location = New Point(236, 8)
        CardActivePerusahaan.Margin = New Padding(4)
        CardActivePerusahaan.Name = "CardActivePerusahaan"
        CardActivePerusahaan.Padding = New Padding(18)
        CardActivePerusahaan.ShadowDecoration.CustomizableEdges = CustomizableEdges6
        CardActivePerusahaan.Size = New Size(220, 90)
        CardActivePerusahaan.TabIndex = 1
        ' 
        ' LblActivePerusahaanValue
        ' 
        LblActivePerusahaanValue.BackColor = Color.Transparent
        LblActivePerusahaanValue.Font = New Font("Segoe UI Semibold", 14.0F, FontStyle.Bold)
        ...
        ' 
        ' LblActivePerusahaanTitle
        ' 
        LblActivePerusahaanTitle.BackColor = Color.Transparent
        LblActivePerusahaanTitle.Font = New Font("Segoe UI Semibold", 9.0F, FontStyle.Bold)
        ...
        ' 
        ' CardPendingPerusahaan
        ' 
        CardPendingPerusahaan.BorderColor = Color.FromArgb(CByte(230), CByte(233), CByte(241))
        CardPendingPerusahaan.BorderRadius = 10
        CardPendingPerusahaan.BorderThickness = 1
        CardPendingPerusahaan.Controls.Add(LblPendingPerusahaanValue)
        CardPendingPerusahaan.Controls.Add(LblPendingPerusahaanTitle)
        CardPendingPerusahaan.CustomizableEdges = CustomizableEdges7
        CardPendingPerusahaan.FillColor = Color.White
        CardPendingPerusahaan.Location = New Point(464, 8)
        CardPendingPerusahaan.Margin = New Padding(4)
        CardPendingPerusahaan.Name = "CardPendingPerusahaan"
        CardPendingPerusahaan.Padding = New Padding(18)
        CardPendingPerusahaan.ShadowDecoration.CustomizableEdges = CustomizableEdges8
        CardPendingPerusahaan.Size = New Size(220, 90)
        CardPendingPerusahaan.TabIndex = 2
        ' 
        ' LblPendingPerusahaanValue
        ' 
        LblPendingPerusahaanValue.BackColor = Color.Transparent
        LblPendingPerusahaanValue.Font = New Font("Segoe UI Semibold", 14.0F, FontStyle.Bold)
        ...
        ' 
        ' LblPendingPerusahaanTitle
        ' 
        LblPendingPerusahaanTitle.BackColor = Color.Transparent
        LblPendingPerusahaanTitle.Font = New Font("Segoe UI Semibold", 9.0F, FontStyle.Bold)
        ...
        ' 
        ' CardInactivePerusahaan
        ' 
        CardInactivePerusahaan.BorderColor = Color.FromArgb(CByte(230), CByte(233), CByte(241))
        CardInactivePerusahaan.BorderRadius = 10
        CardInactivePerusahaan.BorderThickness = 1
        CardInactivePerusahaan.Controls.Add(LblInactivePerusahaanValue)
        CardInactivePerusahaan.Controls.Add(LblInactivePerusahaanTitle)
        CardInactivePerusahaan.CustomizableEdges = CustomizableEdges9
        CardInactivePerusahaan.FillColor = Color.White
        CardInactivePerusahaan.Location = New Point(692, 8)
        CardInactivePerusahaan.Margin = New Padding(4)
        CardInactivePerusahaan.Name = "CardInactivePerusahaan"
        CardInactivePerusahaan.Padding = New Padding(18)
        CardInactivePerusahaan.ShadowDecoration.CustomizableEdges = CustomizableEdges10
        CardInactivePerusahaan.Size = New Size(220, 90)
        CardInactivePerusahaan.TabIndex = 3
        ' 
        ' LblInactivePerusahaanValue
        ' 
        LblInactivePerusahaanValue.BackColor = Color.Transparent
        LblInactivePerusahaanValue.Font = New Font("Segoe UI Semibold", 14.0F, FontStyle.Bold)
        ...
        ' 
        ' LblInactivePerusahaanTitle
        ' 
        LblInactivePerusahaanTitle.BackColor = Color.Transparent
        LblInactivePerusahaanTitle.Font = New Font("Segoe UI Semibold", 9.0F, FontStyle.Bold)
        ...
        PanelFilters.CustomizableEdges = CustomizableEdges19
        PanelFilters.FillColor = Color.White
        PanelFilters.Location = New Point(210, 240)
        PanelFilters.Name = "PanelFilters"
        PanelFilters.Padding = New Padding(12)
        PanelFilters.ShadowDecoration.CustomizableEdges = CustomizableEdges20
        ...
        BtnAddPerusahaan.CustomizableEdges = CustomizableEdges11
        BtnAddPerusahaan.FillColor = Color.FromArgb(CByte(156), CByte(0), CByte(219))
        BtnAddPerusahaan.Font = New Font("Segoe UI Semibold", 9.0F, FontStyle.Bold)
        ...
        BtnAddPerusahaan.ShadowDecoration.CustomizableEdges = CustomizableEdges12
        ...
        PanelTable.CustomizableEdges = CustomizableEdges21
        PanelTable.FillColor = Color.White
        PanelTable.Location = New Point(210, 330)
        PanelTable.Name = "PanelTable"
        PanelTable.Padding = New Padding(18)
        PanelTable.ShadowDecoration.CustomizableEdges = CustomizableEdges22
        ...
        GridPerusahaan.ThemeStyle.HeaderStyle.Font = New Font("Segoe UI", 9.0F)
        ...
        GridPerusahaan.ThemeStyle.RowsStyle.Font = New Font("Segoe UI", 9.0F)
        ...
        CardTotalPerusahaan.ResumeLayout(False)
        CardTotalPerusahaan.PerformLayout()
        CardActivePerusahaan.ResumeLayout(False)
        CardActivePerusahaan.PerformLayout()
        CardPendingPerusahaan.ResumeLayout(False)
        CardPendingPerusahaan.PerformLayout()
        CardInactivePerusahaan.ResumeLayout(False)
        CardInactivePerusahaan.PerformLayout()
    ...
    Friend WithEvents CardTotalPerusahaan As Guna.UI2.WinForms.Guna2Panel
    Friend WithEvents LblTotalPerusahaanTitle As Guna.UI2.WinForms.Guna2HtmlLabel
    Friend WithEvents LblTotalPerusahaanValue As Guna.UI2.WinForms.Guna2HtmlLabel
    Friend WithEvents CardActivePerusahaan As Guna.UI2.WinForms.Guna2Panel
    Friend WithEvents LblActivePerusahaanTitle As Guna.UI2.WinForms.Guna2HtmlLabel
    Friend WithEvents LblActivePerusahaanValue As Guna.UI2.WinForms.Guna2HtmlLabel
    Friend WithEvents CardPendingPerusahaan As Guna.UI2.WinForms.Guna2Panel
    Friend WithEvents LblPendingPerusahaanTitle As Guna.UI2.WinForms.Guna2HtmlLabel
    Friend WithEvents LblPendingPerusahaanValue As Guna.UI2.WinForms.Guna2HtmlLabel
    Friend WithEvents CardInactivePerusahaan As Guna.UI2.WinForms.Guna2Panel
    Friend WithEvents LblInactivePerusahaanTitle As Guna.UI2.WinForms.Guna2HtmlLabel
    Friend WithEvents LblInactivePerusahaanValue As Guna.UI2.WinForms.Guna2HtmlLabel

...
Partial Class wp_navbar
    ...
    Private Sub InitializeComponent()
        ...
        Guna2Panel1.Controls.Add(Guna2PictureBox6)
        ...
        btnDataDiri.DisabledState.ForeColor = Color.FromArgb(CByte(141), CByte(141), CByte(141))
        btnDataDiri.FillColor = Color.Transparent
        btnDataDiri.Font = New Font("Segoe UI", 10.0F)
        btnDataDiri.ForeColor = Color.Black
        btnDataDiri.Image = My.Resources.Resources.user__2_
        btnDataDiri.ImageAlign = HorizontalAlignment.Left
        btnDataDiri.ImageOffset = New Point(10, 0)
        ...
        ' btnBuktiPotong
        ' 
        btnBuktiPotong.BackColor = Color.Transparent
        btnBuktiPotong.BorderRadius = 10
        btnBuktiPotong.ButtonMode = Guna.UI2.WinForms.Enums.ButtonMode.RadioButton
        btnBuktiPotong.CheckedState.FillColor = Color.FromArgb(CByte(106), CByte(90), CByte(232))
        btnBuktiPotong.CheckedState.ForeColor = Color.White
        btnBuktiPotong.CustomizableEdges = CustomizableEdges7
        btnBuktiPotong.DisabledState.BorderColor = Color.DarkGray
        btnBuktiPotong.DisabledState.CustomBorderColor = Color.DarkGray
        btnBuktiPotong.DisabledState.FillColor = Color.FromArgb(CByte(169), CByte(169), CByte(169))
        btnBuktiPotong.DisabledState.ForeColor = Color.FromArgb(CByte(141), CByte(141), CByte(141))
        ...
        btnBuktiPotong.TextOffset = New Point(20, 0)
        ' 
        ' btnLapor
        ' 
        btnLapor.BackColor = Color.Transparent
        btnLapor.BorderRadius = 10
        btnLapor.ButtonMode = Guna.UI2.WinForms.Enums.ButtonMode.RadioButton
        btnLapor.CheckedState.FillColor = Color.FromArgb(CByte(106), CByte(90), CByte(232))
        btnLapor.CheckedState.ForeColor = Color.White
        btnLapor.CustomizableEdges = CustomizableEdges9
        btnLapor.DisabledState.BorderColor = Color.DarkGray
        btnLapor.DisabledState.CustomBorderColor = Color.DarkGray
        btnLapor.DisabledState.FillColor = Color.FromArgb(CByte(169), CByte(169), CByte(169))
        btnLapor.DisabledState.ForeColor = Color.FromArgb(CByte(141), CByte(141), CByte(141))
        ...
        Guna2PictureBox6.Image = My.Resources.Resources.taxify_logo
        Guna2PictureBox6.ImageRotate = 0F
        Guna2PictureBox6.Location = New Point(35, 46)
        Guna2PictureBox6.Margin = New Padding(3, 4, 3, 4)
        ...
        Guna2HtmlLabel6.Font = New Font("Segoe UI", 14.0F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        Guna2HtmlLabel6.ForeColor = Color.Black
        Guna2HtmlLabel6.Location = New Point(71, 46)
        Guna2HtmlLabel6.Margin = New Padding(3, 4, 3, 4)
        Guna2HtmlLabel6.Name = "Guna2HtmlLabel6"
        Guna2HtmlLabel6.Size = New Size(57, 27)
        Guna2HtmlLabel6.TabIndex = 11
        Guna2HtmlLabel6.Text = "Taxify"
        ' 
        ' wp_navbar
        ' 
        AutoScaleMode = AutoScaleMode.None
        BackColor = Color.FromArgb(CByte(84), CByte(64), CByte(209))
